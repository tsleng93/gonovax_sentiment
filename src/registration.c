...
extern SEXP model_withoutPN_contents(SEXP);
extern SEXP model_withoutPN_create(SEXP);
extern SEXP model_withoutPN_initial_conditions(SEXP, SEXP);
extern SEXP model_withoutPN_metadata(SEXP);
extern SEXP model_withoutPN_rhs_r(SEXP, SEXP, SEXP);
extern SEXP model_withoutPN_set_initial(SEXP, SEXP, SEXP, SEXP);
extern SEXP model_withoutPN_set_user(SEXP, SEXP);
...
void R_init_gonovaxsentiment(DllInfo *dll)
{
