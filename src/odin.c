...
typedef struct model_internal {
  ...
  int dim_cum_incid_1;
  int dim_cum_incid_2;
  int dim_cum_lifeyears_U;
  int dim_cum_lifeyears_U_1;
  int dim_cum_lifeyears_U_2;
  int dim_cum_offered;
  ...
  double *initial_cum_lifeyears_U;
  ...
  int offset_variable_cum_lifeyears_U;
...
void model_finalise(SEXP internal_p) {
  ...
  if (internal_p) {
    ...
    R_Free(internal->initial_cum_lifeyears_U);
...
SEXP model_create(SEXP user) {
  ...
  internal->initial_cum_lifeyears_U = NULL;
  ...
  internal->wU = NULL;
  internal->n_group = 2;
  internal->vax_switch_2 = 1;
  internal->vax_switch_3 = 1;
...
SEXP model_contents(SEXP internal_p) {
  ...
  SET_VECTOR_ELT(contents, 15, ScalarInteger(internal->dim_C_hesgroup));
  SET_VECTOR_ELT(contents, 16, ScalarInteger(internal->dim_C_hesgroup_1));
  SET_VECTOR_ELT(contents, 17, ScalarInteger(internal->dim_C_hesgroup_12));
  SET_VECTOR_ELT(contents, 18, ScalarInteger(internal->dim_C_hesgroup_2));
  SET_VECTOR_ELT(contents, 19, ScalarInteger(internal->dim_C_hesgroup_3));
  SET_VECTOR_ELT(contents, 20, ScalarInteger(internal->dim_cum_diag_a));
  SET_VECTOR_ELT(contents, 21, ScalarInteger(internal->dim_cum_diag_a_1));
  SET_VECTOR_ELT(contents, 22, ScalarInteger(internal->dim_cum_diag_a_2));
  SET_VECTOR_ELT(contents, 23, ScalarInteger(internal->dim_cum_diag_s));
  SET_VECTOR_ELT(contents, 24, ScalarInteger(internal->dim_cum_diag_s_1));
  SET_VECTOR_ELT(contents, 25, ScalarInteger(internal->dim_cum_diag_s_2));
  SET_VECTOR_ELT(contents, 26, ScalarInteger(internal->dim_cum_entrants));
  SET_VECTOR_ELT(contents, 27, ScalarInteger(internal->dim_cum_entrants_1));
  SET_VECTOR_ELT(contents, 28, ScalarInteger(internal->dim_cum_entrants_2));
  SET_VECTOR_ELT(contents, 29, ScalarInteger(internal->dim_cum_incid));
  SET_VECTOR_ELT(contents, 30, ScalarInteger(internal->dim_cum_incid_1));
  SET_VECTOR_ELT(contents, 31, ScalarInteger(internal->dim_cum_incid_2));
  SET_VECTOR_ELT(contents, 32, ScalarInteger(internal->dim_cum_lifeyears_U));
  SET_VECTOR_ELT(contents, 33, ScalarInteger(internal->dim_cum_lifeyears_U_1));
  SET_VECTOR_ELT(contents, 34, ScalarInteger(internal->dim_cum_lifeyears_U_2));
  SET_VECTOR_ELT(contents, 35, ScalarInteger(internal->dim_cum_offered));
  SET_VECTOR_ELT(contents, 36, ScalarInteger(internal->dim_cum_offered_1));
  SET_VECTOR_ELT(contents, 37, ScalarInteger(internal->dim_cum_offered_2));
  SET_VECTOR_ELT(contents, 38, ScalarInteger(internal->dim_cum_offered_pn));
  SET_VECTOR_ELT(contents, 39, ScalarInteger(internal->dim_cum_offered_pn_1));
  SET_VECTOR_ELT(contents, 40, ScalarInteger(internal->dim_cum_offered_pn_2));
  SET_VECTOR_ELT(contents, 41, ScalarInteger(internal->dim_cum_offered_vbe));
  SET_VECTOR_ELT(contents, 42, ScalarInteger(internal->dim_cum_offered_vbe_1));
  SET_VECTOR_ELT(contents, 43, ScalarInteger(internal->dim_cum_offered_vbe_2));
  SET_VECTOR_ELT(contents, 44, ScalarInteger(internal->dim_cum_screened));
  SET_VECTOR_ELT(contents, 45, ScalarInteger(internal->dim_cum_screened_1));
  SET_VECTOR_ELT(contents, 46, ScalarInteger(internal->dim_cum_screened_2));
  SET_VECTOR_ELT(contents, 47, ScalarInteger(internal->dim_cum_treated));
  SET_VECTOR_ELT(contents, 48, ScalarInteger(internal->dim_cum_treated_1));
  SET_VECTOR_ELT(contents, 49, ScalarInteger(internal->dim_cum_treated_2));
  SET_VECTOR_ELT(contents, 50, ScalarInteger(internal->dim_cum_vaccinated));
  SET_VECTOR_ELT(contents, 51, ScalarInteger(internal->dim_cum_vaccinated_1));
  SET_VECTOR_ELT(contents, 52, ScalarInteger(internal->dim_cum_vaccinated_2));
  SET_VECTOR_ELT(contents, 53, ScalarInteger(internal->dim_cum_vaccinated_pn));
  SET_VECTOR_ELT(contents, 54, ScalarInteger(internal->dim_cum_vaccinated_pn_1));
  SET_VECTOR_ELT(contents, 55, ScalarInteger(internal->dim_cum_vaccinated_pn_2));
  SET_VECTOR_ELT(contents, 56, ScalarInteger(internal->dim_cum_vaccinated_screen));
  SET_VECTOR_ELT(contents, 57, ScalarInteger(internal->dim_cum_vaccinated_screen_1));
  SET_VECTOR_ELT(contents, 58, ScalarInteger(internal->dim_cum_vaccinated_screen_2));
  SET_VECTOR_ELT(contents, 59, ScalarInteger(internal->dim_cum_vbe));
  SET_VECTOR_ELT(contents, 60, ScalarInteger(internal->dim_cum_vbe_1));
  SET_VECTOR_ELT(contents, 61, ScalarInteger(internal->dim_cum_vbe_2));
  SET_VECTOR_ELT(contents, 62, ScalarInteger(internal->dim_diag_rec));
  SET_VECTOR_ELT(contents, 63, ScalarInteger(internal->dim_diag_rec_1));
  SET_VECTOR_ELT(contents, 64, ScalarInteger(internal->dim_diag_rec_12));
  SET_VECTOR_ELT(contents, 65, ScalarInteger(internal->dim_diag_rec_2));
  SET_VECTOR_ELT(contents, 66, ScalarInteger(internal->dim_diag_rec_3));
  SET_VECTOR_ELT(contents, 67, ScalarInteger(internal->dim_entrants));
  SET_VECTOR_ELT(contents, 68, ScalarInteger(internal->dim_entrants_1));
  SET_VECTOR_ELT(contents, 69, ScalarInteger(internal->dim_entrants_2));
  SET_VECTOR_ELT(contents, 70, ScalarInteger(internal->dim_eta));
  SET_VECTOR_ELT(contents, 71, ScalarInteger(internal->dim_eta_h_t));
  SET_VECTOR_ELT(contents, 72, ScalarInteger(internal->dim_eta_l_t));
  SET_VECTOR_ELT(contents, 73, ScalarInteger(internal->dim_foi_LH));
  SET_VECTOR_ELT(contents, 74, ScalarInteger(internal->dim_hesgroupmatrix));
  SET_VECTOR_ELT(contents, 75, ScalarInteger(internal->dim_hesgroupmatrix_1));
  SET_VECTOR_ELT(contents, 76, ScalarInteger(internal->dim_hesgroupmatrix_2));
  SET_VECTOR_ELT(contents, 77, ScalarInteger(internal->dim_I));
  SET_VECTOR_ELT(contents, 78, ScalarInteger(internal->dim_I_1));
  SET_VECTOR_ELT(contents, 79, ScalarInteger(internal->dim_I_2));
  SET_VECTOR_ELT(contents, 80, ScalarInteger(internal->dim_I0));
  SET_VECTOR_ELT(contents, 81, ScalarInteger(internal->dim_I0_1));
  SET_VECTOR_ELT(contents, 82, ScalarInteger(internal->dim_I0_2));
  SET_VECTOR_ELT(contents, 83, ScalarInteger(internal->dim_lambda));
  SET_VECTOR_ELT(contents, 84, ScalarInteger(internal->dim_lambda_1));
  SET_VECTOR_ELT(contents, 85, ScalarInteger(internal->dim_lambda_2));
  SET_VECTOR_ELT(contents, 86, ScalarInteger(internal->dim_N));
  SET_VECTOR_ELT(contents, 87, ScalarInteger(internal->dim_N_1));
  SET_VECTOR_ELT(contents, 88, ScalarInteger(internal->dim_N_2));
  SET_VECTOR_ELT(contents, 89, ScalarInteger(internal->dim_n_AT));
  SET_VECTOR_ELT(contents, 90, ScalarInteger(internal->dim_n_AT_1));
  SET_VECTOR_ELT(contents, 91, ScalarInteger(internal->dim_n_AT_2));
  SET_VECTOR_ELT(contents, 92, ScalarInteger(internal->dim_n_AU));
  SET_VECTOR_ELT(contents, 93, ScalarInteger(internal->dim_n_AU_1));
  SET_VECTOR_ELT(contents, 94, ScalarInteger(internal->dim_n_AU_2));
  SET_VECTOR_ELT(contents, 95, ScalarInteger(internal->dim_n_diag_rec));
  SET_VECTOR_ELT(contents, 96, ScalarInteger(internal->dim_n_diag_rec_1));
  SET_VECTOR_ELT(contents, 97, ScalarInteger(internal->dim_n_diag_rec_12));
  SET_VECTOR_ELT(contents, 98, ScalarInteger(internal->dim_n_diag_rec_2));
  SET_VECTOR_ELT(contents, 99, ScalarInteger(internal->dim_n_diag_rec_3));
  SET_VECTOR_ELT(contents, 100, ScalarInteger(internal->dim_n_doses));
  SET_VECTOR_ELT(contents, 101, ScalarInteger(internal->dim_n_doses_1));
  SET_VECTOR_ELT(contents, 102, ScalarInteger(internal->dim_n_doses_12));
  SET_VECTOR_ELT(contents, 103, ScalarInteger(internal->dim_n_doses_2));
  SET_VECTOR_ELT(contents, 104, ScalarInteger(internal->dim_n_doses_3));
  SET_VECTOR_ELT(contents, 105, ScalarInteger(internal->dim_N_hesgroup));
  SET_VECTOR_ELT(contents, 106, ScalarInteger(internal->dim_N_hesgroup_1));
  SET_VECTOR_ELT(contents, 107, ScalarInteger(internal->dim_N_hesgroup_12));
  SET_VECTOR_ELT(contents, 108, ScalarInteger(internal->dim_N_hesgroup_2));
  SET_VECTOR_ELT(contents, 109, ScalarInteger(internal->dim_N_hesgroup_3));
  SET_VECTOR_ELT(contents, 110, ScalarInteger(internal->dim_n_obe));
  SET_VECTOR_ELT(contents, 111, ScalarInteger(internal->dim_n_obe_1));
  SET_VECTOR_ELT(contents, 112, ScalarInteger(internal->dim_n_obe_12));
  SET_VECTOR_ELT(contents, 113, ScalarInteger(internal->dim_n_obe_2));
  SET_VECTOR_ELT(contents, 114, ScalarInteger(internal->dim_n_obe_3));
  SET_VECTOR_ELT(contents, 115, ScalarInteger(internal->dim_n_ood));
  SET_VECTOR_ELT(contents, 116, ScalarInteger(internal->dim_n_ood_1));
  SET_VECTOR_ELT(contents, 117, ScalarInteger(internal->dim_n_ood_12));
  SET_VECTOR_ELT(contents, 118, ScalarInteger(internal->dim_n_ood_2));
  SET_VECTOR_ELT(contents, 119, ScalarInteger(internal->dim_n_ood_3));
  SET_VECTOR_ELT(contents, 120, ScalarInteger(internal->dim_n_oopn));
  SET_VECTOR_ELT(contents, 121, ScalarInteger(internal->dim_n_oopn_1));
  SET_VECTOR_ELT(contents, 122, ScalarInteger(internal->dim_n_oopn_12));
  SET_VECTOR_ELT(contents, 123, ScalarInteger(internal->dim_n_oopn_2));
  SET_VECTOR_ELT(contents, 124, ScalarInteger(internal->dim_n_oopn_3));
  SET_VECTOR_ELT(contents, 125, ScalarInteger(internal->dim_n_oos));
  SET_VECTOR_ELT(contents, 126, ScalarInteger(internal->dim_n_oos_1));
  SET_VECTOR_ELT(contents, 127, ScalarInteger(internal->dim_n_oos_12));
  SET_VECTOR_ELT(contents, 128, ScalarInteger(internal->dim_n_oos_2));
  SET_VECTOR_ELT(contents, 129, ScalarInteger(internal->dim_n_oos_3));
  SET_VECTOR_ELT(contents, 130, ScalarInteger(internal->dim_n_ST));
  SET_VECTOR_ELT(contents, 131, ScalarInteger(internal->dim_n_ST_1));
  SET_VECTOR_ELT(contents, 132, ScalarInteger(internal->dim_n_ST_2));
  SET_VECTOR_ELT(contents, 133, ScalarInteger(internal->dim_n_TU));
  SET_VECTOR_ELT(contents, 134, ScalarInteger(internal->dim_n_TU_1));
  SET_VECTOR_ELT(contents, 135, ScalarInteger(internal->dim_n_TU_2));
  SET_VECTOR_ELT(contents, 136, ScalarInteger(internal->dim_n_UI));
  SET_VECTOR_ELT(contents, 137, ScalarInteger(internal->dim_n_UI_1));
  SET_VECTOR_ELT(contents, 138, ScalarInteger(internal->dim_n_UI_2));
  SET_VECTOR_ELT(contents, 139, ScalarInteger(internal->dim_n_vbe));
  SET_VECTOR_ELT(contents, 140, ScalarInteger(internal->dim_n_vbe_1));
  SET_VECTOR_ELT(contents, 141, ScalarInteger(internal->dim_n_vbe_12));
  SET_VECTOR_ELT(contents, 142, ScalarInteger(internal->dim_n_vbe_2));
  SET_VECTOR_ELT(contents, 143, ScalarInteger(internal->dim_n_vbe_3));
  SET_VECTOR_ELT(contents, 144, ScalarInteger(internal->dim_n_vod));
  SET_VECTOR_ELT(contents, 145, ScalarInteger(internal->dim_n_vod_1));
  SET_VECTOR_ELT(contents, 146, ScalarInteger(internal->dim_n_vod_12));
  SET_VECTOR_ELT(contents, 147, ScalarInteger(internal->dim_n_vod_2));
  SET_VECTOR_ELT(contents, 148, ScalarInteger(internal->dim_n_vod_3));
  SET_VECTOR_ELT(contents, 149, ScalarInteger(internal->dim_n_vopn));
  SET_VECTOR_ELT(contents, 150, ScalarInteger(internal->dim_n_vopn_1));
  SET_VECTOR_ELT(contents, 151, ScalarInteger(internal->dim_n_vopn_12));
  SET_VECTOR_ELT(contents, 152, ScalarInteger(internal->dim_n_vopn_2));
  SET_VECTOR_ELT(contents, 153, ScalarInteger(internal->dim_n_vopn_3));
  SET_VECTOR_ELT(contents, 154, ScalarInteger(internal->dim_n_vos));
  SET_VECTOR_ELT(contents, 155, ScalarInteger(internal->dim_n_vos_1));
  SET_VECTOR_ELT(contents, 156, ScalarInteger(internal->dim_n_vos_12));
  SET_VECTOR_ELT(contents, 157, ScalarInteger(internal->dim_n_vos_2));
  SET_VECTOR_ELT(contents, 158, ScalarInteger(internal->dim_n_vos_3));
  SET_VECTOR_ELT(contents, 159, ScalarInteger(internal->dim_Np));
  SET_VECTOR_ELT(contents, 160, ScalarInteger(internal->dim_omega_U));
  SET_VECTOR_ELT(contents, 161, ScalarInteger(internal->dim_omega_U_1));
  SET_VECTOR_ELT(contents, 162, ScalarInteger(internal->dim_omega_U_2));
  SET_VECTOR_ELT(contents, 163, ScalarInteger(internal->dim_omega_U_withdiag));
  SET_VECTOR_ELT(contents, 164, ScalarInteger(internal->dim_omega_U_withdiag_1));
  SET_VECTOR_ELT(contents, 165, ScalarInteger(internal->dim_omega_U_withdiag_2));
  SET_VECTOR_ELT(contents, 166, ScalarInteger(internal->dim_omega_U_withdiag_rg));
  SET_VECTOR_ELT(contents, 167, ScalarInteger(internal->dim_p));
  SET_VECTOR_ELT(contents, 168, ScalarInteger(internal->dim_phi));
  SET_VECTOR_ELT(contents, 169, ScalarInteger(internal->dim_phi_1));
  SET_VECTOR_ELT(contents, 170, ScalarInteger(internal->dim_phi_2));
  SET_VECTOR_ELT(contents, 171, ScalarInteger(internal->dim_prop_C));
  SET_VECTOR_ELT(contents, 172, ScalarInteger(internal->dim_prop_C_hesgroup));
  SET_VECTOR_ELT(contents, 173, ScalarInteger(internal->dim_prop_C_hesriskgroup));
  SET_VECTOR_ELT(contents, 174, ScalarInteger(internal->dim_prop_C_hesriskgroup_1));
  SET_VECTOR_ELT(contents, 175, ScalarInteger(internal->dim_prop_C_hesriskgroup_2));
  SET_VECTOR_ELT(contents, 176, ScalarInteger(internal->dim_prop_UUsubgroup));
  SET_VECTOR_ELT(contents, 177, ScalarInteger(internal->dim_prop_UUsubgroup_1));
  SET_VECTOR_ELT(contents, 178, ScalarInteger(internal->dim_prop_UUsubgroup_2));
  SET_VECTOR_ELT(contents, 179, ScalarInteger(internal->dim_q));
  SET_VECTOR_ELT(contents, 180, ScalarInteger(internal->dim_S));
  SET_VECTOR_ELT(contents, 181, ScalarInteger(internal->dim_S_1));
  SET_VECTOR_ELT(contents, 182, ScalarInteger(internal->dim_S_2));
  SET_VECTOR_ELT(contents, 183, ScalarInteger(internal->dim_S0));
  SET_VECTOR_ELT(contents, 184, ScalarInteger(internal->dim_S0_1));
  SET_VECTOR_ELT(contents, 185, ScalarInteger(internal->dim_S0_2));
  SET_VECTOR_ELT(contents, 186, ScalarInteger(internal->dim_screened));
  SET_VECTOR_ELT(contents, 187, ScalarInteger(internal->dim_screened_1));
  SET_VECTOR_ELT(contents, 188, ScalarInteger(internal->dim_screened_2));
  SET_VECTOR_ELT(contents, 189, ScalarInteger(internal->dim_stratum_doses));
  SET_VECTOR_ELT(contents, 190, ScalarInteger(internal->dim_T));
  SET_VECTOR_ELT(contents, 191, ScalarInteger(internal->dim_T_1));
  SET_VECTOR_ELT(contents, 192, ScalarInteger(internal->dim_T_2));
  SET_VECTOR_ELT(contents, 193, ScalarInteger(internal->dim_T0));
  SET_VECTOR_ELT(contents, 194, ScalarInteger(internal->dim_T0_1));
  SET_VECTOR_ELT(contents, 195, ScalarInteger(internal->dim_T0_2));
  SET_VECTOR_ELT(contents, 196, ScalarInteger(internal->dim_tt));
  SET_VECTOR_ELT(contents, 197, ScalarInteger(internal->dim_U));
  SET_VECTOR_ELT(contents, 198, ScalarInteger(internal->dim_U_1));
  SET_VECTOR_ELT(contents, 199, ScalarInteger(internal->dim_U_2));
  SET_VECTOR_ELT(contents, 200, ScalarInteger(internal->dim_u_d));
  SET_VECTOR_ELT(contents, 201, ScalarInteger(internal->dim_u_d_1));
  SET_VECTOR_ELT(contents, 202, ScalarInteger(internal->dim_u_d_12));
  SET_VECTOR_ELT(contents, 203, ScalarInteger(internal->dim_u_d_2));
  SET_VECTOR_ELT(contents, 204, ScalarInteger(internal->dim_u_d_3));
  SET_VECTOR_ELT(contents, 205, ScalarInteger(internal->dim_u_pn));
  SET_VECTOR_ELT(contents, 206, ScalarInteger(internal->dim_u_pn_1));
  SET_VECTOR_ELT(contents, 207, ScalarInteger(internal->dim_u_pn_12));
  SET_VECTOR_ELT(contents, 208, ScalarInteger(internal->dim_u_pn_2));
  SET_VECTOR_ELT(contents, 209, ScalarInteger(internal->dim_u_pn_3));
  SET_VECTOR_ELT(contents, 210, ScalarInteger(internal->dim_u_s));
  SET_VECTOR_ELT(contents, 211, ScalarInteger(internal->dim_u_s_1));
  SET_VECTOR_ELT(contents, 212, ScalarInteger(internal->dim_u_s_12));
  SET_VECTOR_ELT(contents, 213, ScalarInteger(internal->dim_u_s_2));
  SET_VECTOR_ELT(contents, 214, ScalarInteger(internal->dim_u_s_3));
  SET_VECTOR_ELT(contents, 215, ScalarInteger(internal->dim_U0));
  SET_VECTOR_ELT(contents, 216, ScalarInteger(internal->dim_U0_1));
  SET_VECTOR_ELT(contents, 217, ScalarInteger(internal->dim_U0_2));
  SET_VECTOR_ELT(contents, 218, ScalarInteger(internal->dim_Up));
  SET_VECTOR_ELT(contents, 219, ScalarInteger(internal->dim_vax_t));
  SET_VECTOR_ELT(contents, 220, ScalarInteger(internal->dim_vax_y));
  SET_VECTOR_ELT(contents, 221, ScalarInteger(internal->dim_vbe));
  SET_VECTOR_ELT(contents, 222, ScalarInteger(internal->dim_vbe_1));
  SET_VECTOR_ELT(contents, 223, ScalarInteger(internal->dim_vbe_12));
  SET_VECTOR_ELT(contents, 224, ScalarInteger(internal->dim_vbe_2));
  SET_VECTOR_ELT(contents, 225, ScalarInteger(internal->dim_vbe_3));
  SET_VECTOR_ELT(contents, 226, ScalarInteger(internal->dim_vea));
  SET_VECTOR_ELT(contents, 227, ScalarInteger(internal->dim_ved));
  SET_VECTOR_ELT(contents, 228, ScalarInteger(internal->dim_vei));
  SET_VECTOR_ELT(contents, 229, ScalarInteger(internal->dim_ves));
  SET_VECTOR_ELT(contents, 230, ScalarInteger(internal->dim_vod));
  SET_VECTOR_ELT(contents, 231, ScalarInteger(internal->dim_vod_1));
  SET_VECTOR_ELT(contents, 232, ScalarInteger(internal->dim_vod_12));
  SET_VECTOR_ELT(contents, 233, ScalarInteger(internal->dim_vod_2));
  SET_VECTOR_ELT(contents, 234, ScalarInteger(internal->dim_vod_3));
  SET_VECTOR_ELT(contents, 235, ScalarInteger(internal->dim_vopn));
  SET_VECTOR_ELT(contents, 236, ScalarInteger(internal->dim_vopn_1));
  SET_VECTOR_ELT(contents, 237, ScalarInteger(internal->dim_vopn_12));
  SET_VECTOR_ELT(contents, 238, ScalarInteger(internal->dim_vopn_2));
  SET_VECTOR_ELT(contents, 239, ScalarInteger(internal->dim_vopn_3));
  SET_VECTOR_ELT(contents, 240, ScalarInteger(internal->dim_vos));
  SET_VECTOR_ELT(contents, 241, ScalarInteger(internal->dim_vos_1));
  SET_VECTOR_ELT(contents, 242, ScalarInteger(internal->dim_vos_12));
  SET_VECTOR_ELT(contents, 243, ScalarInteger(internal->dim_vos_2));
  SET_VECTOR_ELT(contents, 244, ScalarInteger(internal->dim_vos_3));
  SET_VECTOR_ELT(contents, 245, ScalarInteger(internal->dim_w));
  SET_VECTOR_ELT(contents, 246, ScalarInteger(internal->dim_w_1));
  SET_VECTOR_ELT(contents, 247, ScalarInteger(internal->dim_w_2));
  SET_VECTOR_ELT(contents, 248, ScalarInteger(internal->dim_wA));
  SET_VECTOR_ELT(contents, 249, ScalarInteger(internal->dim_wA_1));
  SET_VECTOR_ELT(contents, 250, ScalarInteger(internal->dim_wA_12));
  SET_VECTOR_ELT(contents, 251, ScalarInteger(internal->dim_wA_2));
  SET_VECTOR_ELT(contents, 252, ScalarInteger(internal->dim_wA_3));
  SET_VECTOR_ELT(contents, 253, ScalarInteger(internal->dim_wd));
  SET_VECTOR_ELT(contents, 254, ScalarInteger(internal->dim_wd_1));
  SET_VECTOR_ELT(contents, 255, ScalarInteger(internal->dim_wd_2));
  SET_VECTOR_ELT(contents, 256, ScalarInteger(internal->dim_wdA));
  SET_VECTOR_ELT(contents, 257, ScalarInteger(internal->dim_wdA_1));
  SET_VECTOR_ELT(contents, 258, ScalarInteger(internal->dim_wdA_12));
  SET_VECTOR_ELT(contents, 259, ScalarInteger(internal->dim_wdA_2));
  SET_VECTOR_ELT(contents, 260, ScalarInteger(internal->dim_wdA_3));
  SET_VECTOR_ELT(contents, 261, ScalarInteger(internal->dim_wdI));
  SET_VECTOR_ELT(contents, 262, ScalarInteger(internal->dim_wdI_1));
  SET_VECTOR_ELT(contents, 263, ScalarInteger(internal->dim_wdI_12));
  SET_VECTOR_ELT(contents, 264, ScalarInteger(internal->dim_wdI_2));
  SET_VECTOR_ELT(contents, 265, ScalarInteger(internal->dim_wdI_3));
  SET_VECTOR_ELT(contents, 266, ScalarInteger(internal->dim_wdS));
  SET_VECTOR_ELT(contents, 267, ScalarInteger(internal->dim_wdS_1));
  SET_VECTOR_ELT(contents, 268, ScalarInteger(internal->dim_wdS_12));
  SET_VECTOR_ELT(contents, 269, ScalarInteger(internal->dim_wdS_2));
  SET_VECTOR_ELT(contents, 270, ScalarInteger(internal->dim_wdS_3));
  SET_VECTOR_ELT(contents, 271, ScalarInteger(internal->dim_wdT));
  SET_VECTOR_ELT(contents, 272, ScalarInteger(internal->dim_wdT_1));
  SET_VECTOR_ELT(contents, 273, ScalarInteger(internal->dim_wdT_12));
  SET_VECTOR_ELT(contents, 274, ScalarInteger(internal->dim_wdT_2));
  SET_VECTOR_ELT(contents, 275, ScalarInteger(internal->dim_wdT_3));
  SET_VECTOR_ELT(contents, 276, ScalarInteger(internal->dim_wdU));
  SET_VECTOR_ELT(contents, 277, ScalarInteger(internal->dim_wdU_1));
  SET_VECTOR_ELT(contents, 278, ScalarInteger(internal->dim_wdU_12));
  SET_VECTOR_ELT(contents, 279, ScalarInteger(internal->dim_wdU_2));
  SET_VECTOR_ELT(contents, 280, ScalarInteger(internal->dim_wdU_3));
  SET_VECTOR_ELT(contents, 281, ScalarInteger(internal->dim_wI));
  SET_VECTOR_ELT(contents, 282, ScalarInteger(internal->dim_wI_1));
  SET_VECTOR_ELT(contents, 283, ScalarInteger(internal->dim_wI_12));
  SET_VECTOR_ELT(contents, 284, ScalarInteger(internal->dim_wI_2));
  SET_VECTOR_ELT(contents, 285, ScalarInteger(internal->dim_wI_3));
  SET_VECTOR_ELT(contents, 286, ScalarInteger(internal->dim_willing));
  SET_VECTOR_ELT(contents, 287, ScalarInteger(internal->dim_wS));
  SET_VECTOR_ELT(contents, 288, ScalarInteger(internal->dim_wS_1));
  SET_VECTOR_ELT(contents, 289, ScalarInteger(internal->dim_wS_12));
  SET_VECTOR_ELT(contents, 290, ScalarInteger(internal->dim_wS_2));
  SET_VECTOR_ELT(contents, 291, ScalarInteger(internal->dim_wS_3));
  SET_VECTOR_ELT(contents, 292, ScalarInteger(internal->dim_wT));
  SET_VECTOR_ELT(contents, 293, ScalarInteger(internal->dim_wT_1));
  SET_VECTOR_ELT(contents, 294, ScalarInteger(internal->dim_wT_12));
  SET_VECTOR_ELT(contents, 295, ScalarInteger(internal->dim_wT_2));
  SET_VECTOR_ELT(contents, 296, ScalarInteger(internal->dim_wT_3));
  SET_VECTOR_ELT(contents, 297, ScalarInteger(internal->dim_wU));
  SET_VECTOR_ELT(contents, 298, ScalarInteger(internal->dim_wU_1));
  SET_VECTOR_ELT(contents, 299, ScalarInteger(internal->dim_wU_12));
  SET_VECTOR_ELT(contents, 300, ScalarInteger(internal->dim_wU_2));
  SET_VECTOR_ELT(contents, 301, ScalarInteger(internal->dim_wU_3));
  SET_VECTOR_ELT(contents, 302, ScalarReal(internal->enr));
  ...
  SET_VECTOR_ELT(contents, 303, entrants);
  SET_VECTOR_ELT(contents, 304, ScalarReal(internal->epsilon));
  SET_VECTOR_ELT(contents, 305, ScalarReal(internal->epsilon_hes));
  SEXP eta = PROTECT(allocVector(REALSXP, internal->dim_eta));
  memcpy(REAL(eta), internal->eta, internal->dim_eta * sizeof(double));
  SET_VECTOR_ELT(contents, 306, eta);
  ...
  SET_VECTOR_ELT(contents, 307, eta_h_t);
  ...
  SET_VECTOR_ELT(contents, 308, eta_l_t);
  SET_VECTOR_ELT(contents, 309, ScalarReal(internal->exr));
  ...
  SET_VECTOR_ELT(contents, 310, foi_LH);
  ...
  SET_VECTOR_ELT(contents, 311, hesgroupmatrix);
  ...
  SET_VECTOR_ELT(contents, 312, I0);
  ...
  SET_VECTOR_ELT(contents, 313, initial_A);
  ...
  SET_VECTOR_ELT(contents, 314, initial_cum_diag_a);
  ...
  SET_VECTOR_ELT(contents, 315, initial_cum_diag_s);
  ...
  SET_VECTOR_ELT(contents, 316, initial_cum_entrants);
  ...
  SET_VECTOR_ELT(contents, 317, initial_cum_incid);
  SEXP initial_cum_lifeyears_U = PROTECT(allocVector(REALSXP, internal->dim_cum_lifeyears_U));
  memcpy(REAL(initial_cum_lifeyears_U), internal->initial_cum_lifeyears_U, internal->dim_cum_lifeyears_U * sizeof(double));
  odin_set_dim(initial_cum_lifeyears_U, 2, internal->dim_cum_lifeyears_U_1, internal->dim_cum_lifeyears_U_2);
  SET_VECTOR_ELT(contents, 318, initial_cum_lifeyears_U);
  ...
  SET_VECTOR_ELT(contents, 319, initial_cum_offered);
  ...
  SET_VECTOR_ELT(contents, 320, initial_cum_offered_pn);
  ...
  SET_VECTOR_ELT(contents, 321, initial_cum_offered_vbe);
  ...
  SET_VECTOR_ELT(contents, 322, initial_cum_screened);
  ...
  SET_VECTOR_ELT(contents, 323, initial_cum_treated);
  ...
  SET_VECTOR_ELT(contents, 324, initial_cum_vaccinated);
  ...
  SET_VECTOR_ELT(contents, 325, initial_cum_vaccinated_pn);
  ...
  SET_VECTOR_ELT(contents, 326, initial_cum_vaccinated_screen);
  ...
  SET_VECTOR_ELT(contents, 327, initial_cum_vbe);
  ...
  SET_VECTOR_ELT(contents, 328, initial_I);
  ...
  SET_VECTOR_ELT(contents, 329, initial_S);
  ...
  SET_VECTOR_ELT(contents, 330, initial_T);
  ...
  SET_VECTOR_ELT(contents, 331, initial_U);
  SET_VECTOR_ELT(contents, 336, ScalarReal(internal->kappa));
  ...
  SET_VECTOR_ELT(contents, 337, lambda);
  SET_VECTOR_ELT(contents, 338, ScalarReal(internal->mu));
  ...
  SET_VECTOR_ELT(contents, 340, n_AT);
  ...
  SET_VECTOR_ELT(contents, 341, n_AU);
  ...
  SET_VECTOR_ELT(contents, 342, n_diag_rec);
  SEXP n_doses = PROTECT(allocVector(REALSXP, internal->dim_n_doses));
  memcpy(REAL(n_doses), internal->n_doses, internal->dim_n_doses * sizeof(double));
  odin_set_dim(n_doses, 3, internal->dim_n_doses_1, internal->dim_n_doses_2, internal->dim_n_doses_3);
  SET_VECTOR_ELT(contents, 343, n_doses);
  SET_VECTOR_ELT(contents, 344, ScalarInteger(internal->n_group));
  ...
  SET_VECTOR_ELT(contents, 345, N_hesgroup);
  ...
  SET_VECTOR_ELT(contents, 346, n_obe);
  ...
  SET_VECTOR_ELT(contents, 347, n_ood);
  ...
  SET_VECTOR_ELT(contents, 348, n_oopn);
  ...
  SET_VECTOR_ELT(contents, 349, n_oos);
  ...
  SET_VECTOR_ELT(contents, 350, n_ST);
  ...
  SET_VECTOR_ELT(contents, 351, n_TU);
  ...
  SET_VECTOR_ELT(contents, 352, n_UI);
  SET_VECTOR_ELT(contents, 353, ScalarInteger(internal->n_vax));
  ...
  SET_VECTOR_ELT(contents, 354, n_vbe);
  ...
  SET_VECTOR_ELT(contents, 355, n_vod);
  ...
  SET_VECTOR_ELT(contents, 356, n_vopn);
  ...
  SET_VECTOR_ELT(contents, 357, n_vos);
  SET_VECTOR_ELT(contents, 358, ScalarReal(internal->notifiedprev));
  SEXP Np = PROTECT(allocVector(REALSXP, internal->dim_Np));
  memcpy(REAL(Np), internal->Np, internal->dim_Np * sizeof(double));
  SET_VECTOR_ELT(contents, 359, Np);
  SET_VECTOR_ELT(contents, 360, ScalarReal(internal->nu));
  SET_VECTOR_ELT(contents, 361, ScalarInteger(internal->offset_variable_A));
  SET_VECTOR_ELT(contents, 362, ScalarInteger(internal->offset_variable_cum_diag_a));
  SET_VECTOR_ELT(contents, 363, ScalarInteger(internal->offset_variable_cum_diag_s));
  SET_VECTOR_ELT(contents, 364, ScalarInteger(internal->offset_variable_cum_entrants));
  SET_VECTOR_ELT(contents, 365, ScalarInteger(internal->offset_variable_cum_incid));
  SET_VECTOR_ELT(contents, 366, ScalarInteger(internal->offset_variable_cum_lifeyears_U));
  SET_VECTOR_ELT(contents, 367, ScalarInteger(internal->offset_variable_cum_offered));
  SET_VECTOR_ELT(contents, 368, ScalarInteger(internal->offset_variable_cum_offered_pn));
  SET_VECTOR_ELT(contents, 369, ScalarInteger(internal->offset_variable_cum_offered_vbe));
  SET_VECTOR_ELT(contents, 370, ScalarInteger(internal->offset_variable_cum_screened));
  SET_VECTOR_ELT(contents, 371, ScalarInteger(internal->offset_variable_cum_treated));
  SET_VECTOR_ELT(contents, 372, ScalarInteger(internal->offset_variable_cum_vaccinated));
  SET_VECTOR_ELT(contents, 373, ScalarInteger(internal->offset_variable_cum_vaccinated_pn));
  SET_VECTOR_ELT(contents, 374, ScalarInteger(internal->offset_variable_cum_vaccinated_screen));
  SET_VECTOR_ELT(contents, 375, ScalarInteger(internal->offset_variable_cum_vbe));
  SET_VECTOR_ELT(contents, 376, ScalarInteger(internal->offset_variable_S));
  SET_VECTOR_ELT(contents, 377, ScalarInteger(internal->offset_variable_T));
  ...
  SET_VECTOR_ELT(contents, 378, omega_U);
  ...
  SET_VECTOR_ELT(contents, 379, omega_U_withdiag);
  ...
  SET_VECTOR_ELT(contents, 382, phi);
  ...
  SET_VECTOR_ELT(contents, 383, prop_C);
  ...
  SET_VECTOR_ELT(contents, 384, prop_C_hesgroup);
  ...
  SET_VECTOR_ELT(contents, 385, prop_C_hesriskgroup);
  ...
  SET_VECTOR_ELT(contents, 386, prop_UUsubgroup);
  SET_VECTOR_ELT(contents, 387, ScalarReal(internal->psi));
  SEXP q = PROTECT(allocVector(REALSXP, internal->dim_q));
  memcpy(REAL(q), internal->q, internal->dim_q * sizeof(double));
  SET_VECTOR_ELT(contents, 388, q);
  SET_VECTOR_ELT(contents, 389, ScalarReal(internal->rho));
  ...
  SET_VECTOR_ELT(contents, 390, S0);
  ...
  SET_VECTOR_ELT(contents, 391, screened);
  SET_VECTOR_ELT(contents, 392, ScalarReal(internal->sigma));
  SEXP stratum_doses = PROTECT(allocVector(REALSXP, internal->dim_stratum_doses));
  memcpy(REAL(stratum_doses), internal->stratum_doses, internal->dim_stratum_doses * sizeof(double));
  SET_VECTOR_ELT(contents, 393, stratum_doses);
  ...
  SET_VECTOR_ELT(contents, 396, u_d);
  ...
  SET_VECTOR_ELT(contents, 397, u_pn);
  ...
  SET_VECTOR_ELT(contents, 398, u_s);
  SET_VECTOR_ELT(contents, 399, ScalarReal(internal->u_vbe));
  ...
  SET_VECTOR_ELT(contents, 400, U0);
  SEXP Up = PROTECT(allocVector(REALSXP, internal->dim_Up));
  memcpy(REAL(Up), internal->Up, internal->dim_Up * sizeof(double));
  SET_VECTOR_ELT(contents, 401, Up);
  SET_VECTOR_ELT(contents, 402, ScalarReal(internal->vax_switch_2));
  SET_VECTOR_ELT(contents, 403, ScalarReal(internal->vax_switch_3));
  ...
  SET_VECTOR_ELT(contents, 404, vax_t);
  ...
  SET_VECTOR_ELT(contents, 405, vax_y);
  ...
  SET_VECTOR_ELT(contents, 411, vod);
  ...
  SET_VECTOR_ELT(contents, 412, vopn);
  ...
  SET_VECTOR_ELT(contents, 413, vos);
  ...
  SET_VECTOR_ELT(contents, 415, wA);
  ...
  SET_VECTOR_ELT(contents, 416, wd);
  ...
  SET_VECTOR_ELT(contents, 417, wdA);
  ...
  SET_VECTOR_ELT(contents, 418, wdI);
  ...
  SET_VECTOR_ELT(contents, 419, wdS);
  ...
  SET_VECTOR_ELT(contents, 420, wdT);
  ...
  SET_VECTOR_ELT(contents, 421, wdU);
  ...
  SET_VECTOR_ELT(contents, 422, wI);
  ...
  SET_VECTOR_ELT(contents, 423, willing);
  ...
  SET_VECTOR_ELT(contents, 424, wS);
  ...
  SET_VECTOR_ELT(contents, 425, wT);
  ...
  SET_VECTOR_ELT(contents, 426, wU);
  ...
  SET_STRING_ELT(nms, 15, mkChar("dim_C_hesgroup"));
  SET_STRING_ELT(nms, 16, mkChar("dim_C_hesgroup_1"));
  SET_STRING_ELT(nms, 17, mkChar("dim_C_hesgroup_12"));
  SET_STRING_ELT(nms, 18, mkChar("dim_C_hesgroup_2"));
  SET_STRING_ELT(nms, 19, mkChar("dim_C_hesgroup_3"));
  SET_STRING_ELT(nms, 20, mkChar("dim_cum_diag_a"));
  SET_STRING_ELT(nms, 21, mkChar("dim_cum_diag_a_1"));
  SET_STRING_ELT(nms, 22, mkChar("dim_cum_diag_a_2"));
  SET_STRING_ELT(nms, 23, mkChar("dim_cum_diag_s"));
  SET_STRING_ELT(nms, 24, mkChar("dim_cum_diag_s_1"));
  SET_STRING_ELT(nms, 25, mkChar("dim_cum_diag_s_2"));
  SET_STRING_ELT(nms, 26, mkChar("dim_cum_entrants"));
  SET_STRING_ELT(nms, 27, mkChar("dim_cum_entrants_1"));
  SET_STRING_ELT(nms, 28, mkChar("dim_cum_entrants_2"));
  SET_STRING_ELT(nms, 29, mkChar("dim_cum_incid"));
  SET_STRING_ELT(nms, 30, mkChar("dim_cum_incid_1"));
  SET_STRING_ELT(nms, 31, mkChar("dim_cum_incid_2"));
  SET_STRING_ELT(nms, 32, mkChar("dim_cum_lifeyears_U"));
  SET_STRING_ELT(nms, 33, mkChar("dim_cum_lifeyears_U_1"));
  SET_STRING_ELT(nms, 34, mkChar("dim_cum_lifeyears_U_2"));
  SET_STRING_ELT(nms, 35, mkChar("dim_cum_offered"));
  SET_STRING_ELT(nms, 36, mkChar("dim_cum_offered_1"));
  SET_STRING_ELT(nms, 37, mkChar("dim_cum_offered_2"));
  SET_STRING_ELT(nms, 38, mkChar("dim_cum_offered_pn"));
  SET_STRING_ELT(nms, 39, mkChar("dim_cum_offered_pn_1"));
  SET_STRING_ELT(nms, 40, mkChar("dim_cum_offered_pn_2"));
  SET_STRING_ELT(nms, 41, mkChar("dim_cum_offered_vbe"));
  SET_STRING_ELT(nms, 42, mkChar("dim_cum_offered_vbe_1"));
  SET_STRING_ELT(nms, 43, mkChar("dim_cum_offered_vbe_2"));
  SET_STRING_ELT(nms, 44, mkChar("dim_cum_screened"));
  SET_STRING_ELT(nms, 45, mkChar("dim_cum_screened_1"));
  SET_STRING_ELT(nms, 46, mkChar("dim_cum_screened_2"));
  SET_STRING_ELT(nms, 47, mkChar("dim_cum_treated"));
  SET_STRING_ELT(nms, 48, mkChar("dim_cum_treated_1"));
  SET_STRING_ELT(nms, 49, mkChar("dim_cum_treated_2"));
  SET_STRING_ELT(nms, 50, mkChar("dim_cum_vaccinated"));
  SET_STRING_ELT(nms, 51, mkChar("dim_cum_vaccinated_1"));
  SET_STRING_ELT(nms, 52, mkChar("dim_cum_vaccinated_2"));
  SET_STRING_ELT(nms, 53, mkChar("dim_cum_vaccinated_pn"));
  SET_STRING_ELT(nms, 54, mkChar("dim_cum_vaccinated_pn_1"));
  SET_STRING_ELT(nms, 55, mkChar("dim_cum_vaccinated_pn_2"));
  SET_STRING_ELT(nms, 56, mkChar("dim_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 57, mkChar("dim_cum_vaccinated_screen_1"));
  SET_STRING_ELT(nms, 58, mkChar("dim_cum_vaccinated_screen_2"));
  SET_STRING_ELT(nms, 59, mkChar("dim_cum_vbe"));
  SET_STRING_ELT(nms, 60, mkChar("dim_cum_vbe_1"));
  SET_STRING_ELT(nms, 61, mkChar("dim_cum_vbe_2"));
  SET_STRING_ELT(nms, 62, mkChar("dim_diag_rec"));
  SET_STRING_ELT(nms, 63, mkChar("dim_diag_rec_1"));
  SET_STRING_ELT(nms, 64, mkChar("dim_diag_rec_12"));
  SET_STRING_ELT(nms, 65, mkChar("dim_diag_rec_2"));
  SET_STRING_ELT(nms, 66, mkChar("dim_diag_rec_3"));
  SET_STRING_ELT(nms, 67, mkChar("dim_entrants"));
  SET_STRING_ELT(nms, 68, mkChar("dim_entrants_1"));
  SET_STRING_ELT(nms, 69, mkChar("dim_entrants_2"));
  SET_STRING_ELT(nms, 70, mkChar("dim_eta"));
  SET_STRING_ELT(nms, 71, mkChar("dim_eta_h_t"));
  SET_STRING_ELT(nms, 72, mkChar("dim_eta_l_t"));
  SET_STRING_ELT(nms, 73, mkChar("dim_foi_LH"));
  SET_STRING_ELT(nms, 74, mkChar("dim_hesgroupmatrix"));
  SET_STRING_ELT(nms, 75, mkChar("dim_hesgroupmatrix_1"));
  SET_STRING_ELT(nms, 76, mkChar("dim_hesgroupmatrix_2"));
  SET_STRING_ELT(nms, 77, mkChar("dim_I"));
  SET_STRING_ELT(nms, 78, mkChar("dim_I_1"));
  SET_STRING_ELT(nms, 79, mkChar("dim_I_2"));
  SET_STRING_ELT(nms, 80, mkChar("dim_I0"));
  SET_STRING_ELT(nms, 81, mkChar("dim_I0_1"));
  SET_STRING_ELT(nms, 82, mkChar("dim_I0_2"));
  SET_STRING_ELT(nms, 83, mkChar("dim_lambda"));
  SET_STRING_ELT(nms, 84, mkChar("dim_lambda_1"));
  SET_STRING_ELT(nms, 85, mkChar("dim_lambda_2"));
  SET_STRING_ELT(nms, 86, mkChar("dim_N"));
  SET_STRING_ELT(nms, 87, mkChar("dim_N_1"));
  SET_STRING_ELT(nms, 88, mkChar("dim_N_2"));
  SET_STRING_ELT(nms, 89, mkChar("dim_n_AT"));
  SET_STRING_ELT(nms, 90, mkChar("dim_n_AT_1"));
  SET_STRING_ELT(nms, 91, mkChar("dim_n_AT_2"));
  SET_STRING_ELT(nms, 92, mkChar("dim_n_AU"));
  SET_STRING_ELT(nms, 93, mkChar("dim_n_AU_1"));
  SET_STRING_ELT(nms, 94, mkChar("dim_n_AU_2"));
  SET_STRING_ELT(nms, 95, mkChar("dim_n_diag_rec"));
  SET_STRING_ELT(nms, 96, mkChar("dim_n_diag_rec_1"));
  SET_STRING_ELT(nms, 97, mkChar("dim_n_diag_rec_12"));
  SET_STRING_ELT(nms, 98, mkChar("dim_n_diag_rec_2"));
  SET_STRING_ELT(nms, 99, mkChar("dim_n_diag_rec_3"));
  SET_STRING_ELT(nms, 100, mkChar("dim_n_doses"));
  SET_STRING_ELT(nms, 101, mkChar("dim_n_doses_1"));
  SET_STRING_ELT(nms, 102, mkChar("dim_n_doses_12"));
  SET_STRING_ELT(nms, 103, mkChar("dim_n_doses_2"));
  SET_STRING_ELT(nms, 104, mkChar("dim_n_doses_3"));
  SET_STRING_ELT(nms, 105, mkChar("dim_N_hesgroup"));
  SET_STRING_ELT(nms, 106, mkChar("dim_N_hesgroup_1"));
  SET_STRING_ELT(nms, 107, mkChar("dim_N_hesgroup_12"));
  SET_STRING_ELT(nms, 108, mkChar("dim_N_hesgroup_2"));
  SET_STRING_ELT(nms, 109, mkChar("dim_N_hesgroup_3"));
  SET_STRING_ELT(nms, 110, mkChar("dim_n_obe"));
  SET_STRING_ELT(nms, 111, mkChar("dim_n_obe_1"));
  SET_STRING_ELT(nms, 112, mkChar("dim_n_obe_12"));
  SET_STRING_ELT(nms, 113, mkChar("dim_n_obe_2"));
  SET_STRING_ELT(nms, 114, mkChar("dim_n_obe_3"));
  SET_STRING_ELT(nms, 115, mkChar("dim_n_ood"));
  SET_STRING_ELT(nms, 116, mkChar("dim_n_ood_1"));
  SET_STRING_ELT(nms, 117, mkChar("dim_n_ood_12"));
  SET_STRING_ELT(nms, 118, mkChar("dim_n_ood_2"));
  SET_STRING_ELT(nms, 119, mkChar("dim_n_ood_3"));
  SET_STRING_ELT(nms, 120, mkChar("dim_n_oopn"));
  SET_STRING_ELT(nms, 121, mkChar("dim_n_oopn_1"));
  SET_STRING_ELT(nms, 122, mkChar("dim_n_oopn_12"));
  SET_STRING_ELT(nms, 123, mkChar("dim_n_oopn_2"));
  SET_STRING_ELT(nms, 124, mkChar("dim_n_oopn_3"));
  SET_STRING_ELT(nms, 125, mkChar("dim_n_oos"));
  SET_STRING_ELT(nms, 126, mkChar("dim_n_oos_1"));
  SET_STRING_ELT(nms, 127, mkChar("dim_n_oos_12"));
  SET_STRING_ELT(nms, 128, mkChar("dim_n_oos_2"));
  SET_STRING_ELT(nms, 129, mkChar("dim_n_oos_3"));
  SET_STRING_ELT(nms, 130, mkChar("dim_n_ST"));
  SET_STRING_ELT(nms, 131, mkChar("dim_n_ST_1"));
  SET_STRING_ELT(nms, 132, mkChar("dim_n_ST_2"));
  SET_STRING_ELT(nms, 133, mkChar("dim_n_TU"));
  SET_STRING_ELT(nms, 134, mkChar("dim_n_TU_1"));
  SET_STRING_ELT(nms, 135, mkChar("dim_n_TU_2"));
  SET_STRING_ELT(nms, 136, mkChar("dim_n_UI"));
  SET_STRING_ELT(nms, 137, mkChar("dim_n_UI_1"));
  SET_STRING_ELT(nms, 138, mkChar("dim_n_UI_2"));
  SET_STRING_ELT(nms, 139, mkChar("dim_n_vbe"));
  SET_STRING_ELT(nms, 140, mkChar("dim_n_vbe_1"));
  SET_STRING_ELT(nms, 141, mkChar("dim_n_vbe_12"));
  SET_STRING_ELT(nms, 142, mkChar("dim_n_vbe_2"));
  SET_STRING_ELT(nms, 143, mkChar("dim_n_vbe_3"));
  SET_STRING_ELT(nms, 144, mkChar("dim_n_vod"));
  SET_STRING_ELT(nms, 145, mkChar("dim_n_vod_1"));
  SET_STRING_ELT(nms, 146, mkChar("dim_n_vod_12"));
  SET_STRING_ELT(nms, 147, mkChar("dim_n_vod_2"));
  SET_STRING_ELT(nms, 148, mkChar("dim_n_vod_3"));
  SET_STRING_ELT(nms, 149, mkChar("dim_n_vopn"));
  SET_STRING_ELT(nms, 150, mkChar("dim_n_vopn_1"));
  SET_STRING_ELT(nms, 151, mkChar("dim_n_vopn_12"));
  SET_STRING_ELT(nms, 152, mkChar("dim_n_vopn_2"));
  SET_STRING_ELT(nms, 153, mkChar("dim_n_vopn_3"));
  SET_STRING_ELT(nms, 154, mkChar("dim_n_vos"));
  SET_STRING_ELT(nms, 155, mkChar("dim_n_vos_1"));
  SET_STRING_ELT(nms, 156, mkChar("dim_n_vos_12"));
  SET_STRING_ELT(nms, 157, mkChar("dim_n_vos_2"));
  SET_STRING_ELT(nms, 158, mkChar("dim_n_vos_3"));
  SET_STRING_ELT(nms, 159, mkChar("dim_Np"));
  SET_STRING_ELT(nms, 160, mkChar("dim_omega_U"));
  SET_STRING_ELT(nms, 161, mkChar("dim_omega_U_1"));
  SET_STRING_ELT(nms, 162, mkChar("dim_omega_U_2"));
  SET_STRING_ELT(nms, 163, mkChar("dim_omega_U_withdiag"));
  SET_STRING_ELT(nms, 164, mkChar("dim_omega_U_withdiag_1"));
  SET_STRING_ELT(nms, 165, mkChar("dim_omega_U_withdiag_2"));
  SET_STRING_ELT(nms, 166, mkChar("dim_omega_U_withdiag_rg"));
  SET_STRING_ELT(nms, 167, mkChar("dim_p"));
  SET_STRING_ELT(nms, 168, mkChar("dim_phi"));
  SET_STRING_ELT(nms, 169, mkChar("dim_phi_1"));
  SET_STRING_ELT(nms, 170, mkChar("dim_phi_2"));
  SET_STRING_ELT(nms, 171, mkChar("dim_prop_C"));
  SET_STRING_ELT(nms, 172, mkChar("dim_prop_C_hesgroup"));
  SET_STRING_ELT(nms, 173, mkChar("dim_prop_C_hesriskgroup"));
  SET_STRING_ELT(nms, 174, mkChar("dim_prop_C_hesriskgroup_1"));
  SET_STRING_ELT(nms, 175, mkChar("dim_prop_C_hesriskgroup_2"));
  SET_STRING_ELT(nms, 176, mkChar("dim_prop_UUsubgroup"));
  SET_STRING_ELT(nms, 177, mkChar("dim_prop_UUsubgroup_1"));
  SET_STRING_ELT(nms, 178, mkChar("dim_prop_UUsubgroup_2"));
  SET_STRING_ELT(nms, 179, mkChar("dim_q"));
  SET_STRING_ELT(nms, 180, mkChar("dim_S"));
  SET_STRING_ELT(nms, 181, mkChar("dim_S_1"));
  SET_STRING_ELT(nms, 182, mkChar("dim_S_2"));
  SET_STRING_ELT(nms, 183, mkChar("dim_S0"));
  SET_STRING_ELT(nms, 184, mkChar("dim_S0_1"));
  SET_STRING_ELT(nms, 185, mkChar("dim_S0_2"));
  SET_STRING_ELT(nms, 186, mkChar("dim_screened"));
  SET_STRING_ELT(nms, 187, mkChar("dim_screened_1"));
  SET_STRING_ELT(nms, 188, mkChar("dim_screened_2"));
  SET_STRING_ELT(nms, 189, mkChar("dim_stratum_doses"));
  SET_STRING_ELT(nms, 190, mkChar("dim_T"));
  SET_STRING_ELT(nms, 191, mkChar("dim_T_1"));
  SET_STRING_ELT(nms, 192, mkChar("dim_T_2"));
  SET_STRING_ELT(nms, 193, mkChar("dim_T0"));
  SET_STRING_ELT(nms, 194, mkChar("dim_T0_1"));
  SET_STRING_ELT(nms, 195, mkChar("dim_T0_2"));
  SET_STRING_ELT(nms, 196, mkChar("dim_tt"));
  SET_STRING_ELT(nms, 197, mkChar("dim_U"));
  SET_STRING_ELT(nms, 198, mkChar("dim_U_1"));
  SET_STRING_ELT(nms, 199, mkChar("dim_U_2"));
  SET_STRING_ELT(nms, 200, mkChar("dim_u_d"));
  SET_STRING_ELT(nms, 201, mkChar("dim_u_d_1"));
  SET_STRING_ELT(nms, 202, mkChar("dim_u_d_12"));
  SET_STRING_ELT(nms, 203, mkChar("dim_u_d_2"));
  SET_STRING_ELT(nms, 204, mkChar("dim_u_d_3"));
  SET_STRING_ELT(nms, 205, mkChar("dim_u_pn"));
  SET_STRING_ELT(nms, 206, mkChar("dim_u_pn_1"));
  SET_STRING_ELT(nms, 207, mkChar("dim_u_pn_12"));
  SET_STRING_ELT(nms, 208, mkChar("dim_u_pn_2"));
  SET_STRING_ELT(nms, 209, mkChar("dim_u_pn_3"));
  SET_STRING_ELT(nms, 210, mkChar("dim_u_s"));
  SET_STRING_ELT(nms, 211, mkChar("dim_u_s_1"));
  SET_STRING_ELT(nms, 212, mkChar("dim_u_s_12"));
  SET_STRING_ELT(nms, 213, mkChar("dim_u_s_2"));
  SET_STRING_ELT(nms, 214, mkChar("dim_u_s_3"));
  SET_STRING_ELT(nms, 215, mkChar("dim_U0"));
  SET_STRING_ELT(nms, 216, mkChar("dim_U0_1"));
  SET_STRING_ELT(nms, 217, mkChar("dim_U0_2"));
  SET_STRING_ELT(nms, 218, mkChar("dim_Up"));
  SET_STRING_ELT(nms, 219, mkChar("dim_vax_t"));
  SET_STRING_ELT(nms, 220, mkChar("dim_vax_y"));
  SET_STRING_ELT(nms, 221, mkChar("dim_vbe"));
  SET_STRING_ELT(nms, 222, mkChar("dim_vbe_1"));
  SET_STRING_ELT(nms, 223, mkChar("dim_vbe_12"));
  SET_STRING_ELT(nms, 224, mkChar("dim_vbe_2"));
  SET_STRING_ELT(nms, 225, mkChar("dim_vbe_3"));
  SET_STRING_ELT(nms, 226, mkChar("dim_vea"));
  SET_STRING_ELT(nms, 227, mkChar("dim_ved"));
  SET_STRING_ELT(nms, 228, mkChar("dim_vei"));
  SET_STRING_ELT(nms, 229, mkChar("dim_ves"));
  SET_STRING_ELT(nms, 230, mkChar("dim_vod"));
  SET_STRING_ELT(nms, 231, mkChar("dim_vod_1"));
  SET_STRING_ELT(nms, 232, mkChar("dim_vod_12"));
  SET_STRING_ELT(nms, 233, mkChar("dim_vod_2"));
  SET_STRING_ELT(nms, 234, mkChar("dim_vod_3"));
  SET_STRING_ELT(nms, 235, mkChar("dim_vopn"));
  SET_STRING_ELT(nms, 236, mkChar("dim_vopn_1"));
  SET_STRING_ELT(nms, 237, mkChar("dim_vopn_12"));
  SET_STRING_ELT(nms, 238, mkChar("dim_vopn_2"));
  SET_STRING_ELT(nms, 239, mkChar("dim_vopn_3"));
  SET_STRING_ELT(nms, 240, mkChar("dim_vos"));
  SET_STRING_ELT(nms, 241, mkChar("dim_vos_1"));
  SET_STRING_ELT(nms, 242, mkChar("dim_vos_12"));
  SET_STRING_ELT(nms, 243, mkChar("dim_vos_2"));
  SET_STRING_ELT(nms, 244, mkChar("dim_vos_3"));
  SET_STRING_ELT(nms, 245, mkChar("dim_w"));
  SET_STRING_ELT(nms, 246, mkChar("dim_w_1"));
  SET_STRING_ELT(nms, 247, mkChar("dim_w_2"));
  SET_STRING_ELT(nms, 248, mkChar("dim_wA"));
  SET_STRING_ELT(nms, 249, mkChar("dim_wA_1"));
  SET_STRING_ELT(nms, 250, mkChar("dim_wA_12"));
  SET_STRING_ELT(nms, 251, mkChar("dim_wA_2"));
  SET_STRING_ELT(nms, 252, mkChar("dim_wA_3"));
  SET_STRING_ELT(nms, 253, mkChar("dim_wd"));
  SET_STRING_ELT(nms, 254, mkChar("dim_wd_1"));
  SET_STRING_ELT(nms, 255, mkChar("dim_wd_2"));
  SET_STRING_ELT(nms, 256, mkChar("dim_wdA"));
  SET_STRING_ELT(nms, 257, mkChar("dim_wdA_1"));
  SET_STRING_ELT(nms, 258, mkChar("dim_wdA_12"));
  SET_STRING_ELT(nms, 259, mkChar("dim_wdA_2"));
  SET_STRING_ELT(nms, 260, mkChar("dim_wdA_3"));
  SET_STRING_ELT(nms, 261, mkChar("dim_wdI"));
  SET_STRING_ELT(nms, 262, mkChar("dim_wdI_1"));
  SET_STRING_ELT(nms, 263, mkChar("dim_wdI_12"));
  SET_STRING_ELT(nms, 264, mkChar("dim_wdI_2"));
  SET_STRING_ELT(nms, 265, mkChar("dim_wdI_3"));
  SET_STRING_ELT(nms, 266, mkChar("dim_wdS"));
  SET_STRING_ELT(nms, 267, mkChar("dim_wdS_1"));
  SET_STRING_ELT(nms, 268, mkChar("dim_wdS_12"));
  SET_STRING_ELT(nms, 269, mkChar("dim_wdS_2"));
  SET_STRING_ELT(nms, 270, mkChar("dim_wdS_3"));
  SET_STRING_ELT(nms, 271, mkChar("dim_wdT"));
  SET_STRING_ELT(nms, 272, mkChar("dim_wdT_1"));
  SET_STRING_ELT(nms, 273, mkChar("dim_wdT_12"));
  SET_STRING_ELT(nms, 274, mkChar("dim_wdT_2"));
  SET_STRING_ELT(nms, 275, mkChar("dim_wdT_3"));
  SET_STRING_ELT(nms, 276, mkChar("dim_wdU"));
  SET_STRING_ELT(nms, 277, mkChar("dim_wdU_1"));
  SET_STRING_ELT(nms, 278, mkChar("dim_wdU_12"));
  SET_STRING_ELT(nms, 279, mkChar("dim_wdU_2"));
  SET_STRING_ELT(nms, 280, mkChar("dim_wdU_3"));
  SET_STRING_ELT(nms, 281, mkChar("dim_wI"));
  SET_STRING_ELT(nms, 282, mkChar("dim_wI_1"));
  SET_STRING_ELT(nms, 283, mkChar("dim_wI_12"));
  SET_STRING_ELT(nms, 284, mkChar("dim_wI_2"));
  SET_STRING_ELT(nms, 285, mkChar("dim_wI_3"));
  SET_STRING_ELT(nms, 286, mkChar("dim_willing"));
  SET_STRING_ELT(nms, 287, mkChar("dim_wS"));
  SET_STRING_ELT(nms, 288, mkChar("dim_wS_1"));
  SET_STRING_ELT(nms, 289, mkChar("dim_wS_12"));
  SET_STRING_ELT(nms, 290, mkChar("dim_wS_2"));
  SET_STRING_ELT(nms, 291, mkChar("dim_wS_3"));
  SET_STRING_ELT(nms, 292, mkChar("dim_wT"));
  SET_STRING_ELT(nms, 293, mkChar("dim_wT_1"));
  SET_STRING_ELT(nms, 294, mkChar("dim_wT_12"));
  SET_STRING_ELT(nms, 295, mkChar("dim_wT_2"));
  SET_STRING_ELT(nms, 296, mkChar("dim_wT_3"));
  SET_STRING_ELT(nms, 297, mkChar("dim_wU"));
  SET_STRING_ELT(nms, 298, mkChar("dim_wU_1"));
  SET_STRING_ELT(nms, 299, mkChar("dim_wU_12"));
  SET_STRING_ELT(nms, 300, mkChar("dim_wU_2"));
  SET_STRING_ELT(nms, 301, mkChar("dim_wU_3"));
  SET_STRING_ELT(nms, 302, mkChar("enr"));
  SET_STRING_ELT(nms, 303, mkChar("entrants"));
  SET_STRING_ELT(nms, 304, mkChar("epsilon"));
  SET_STRING_ELT(nms, 305, mkChar("epsilon_hes"));
  SET_STRING_ELT(nms, 306, mkChar("eta"));
  SET_STRING_ELT(nms, 307, mkChar("eta_h_t"));
  SET_STRING_ELT(nms, 308, mkChar("eta_l_t"));
  SET_STRING_ELT(nms, 309, mkChar("exr"));
  SET_STRING_ELT(nms, 310, mkChar("foi_LH"));
  SET_STRING_ELT(nms, 311, mkChar("hesgroupmatrix"));
  SET_STRING_ELT(nms, 312, mkChar("I0"));
  SET_STRING_ELT(nms, 313, mkChar("initial_A"));
  SET_STRING_ELT(nms, 314, mkChar("initial_cum_diag_a"));
  SET_STRING_ELT(nms, 315, mkChar("initial_cum_diag_s"));
  SET_STRING_ELT(nms, 316, mkChar("initial_cum_entrants"));
  SET_STRING_ELT(nms, 317, mkChar("initial_cum_incid"));
  SET_STRING_ELT(nms, 318, mkChar("initial_cum_lifeyears_U"));
  SET_STRING_ELT(nms, 319, mkChar("initial_cum_offered"));
  SET_STRING_ELT(nms, 320, mkChar("initial_cum_offered_pn"));
  SET_STRING_ELT(nms, 321, mkChar("initial_cum_offered_vbe"));
  SET_STRING_ELT(nms, 322, mkChar("initial_cum_screened"));
  SET_STRING_ELT(nms, 323, mkChar("initial_cum_treated"));
  SET_STRING_ELT(nms, 324, mkChar("initial_cum_vaccinated"));
  SET_STRING_ELT(nms, 325, mkChar("initial_cum_vaccinated_pn"));
  SET_STRING_ELT(nms, 326, mkChar("initial_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 327, mkChar("initial_cum_vbe"));
  SET_STRING_ELT(nms, 328, mkChar("initial_I"));
  SET_STRING_ELT(nms, 329, mkChar("initial_S"));
  SET_STRING_ELT(nms, 330, mkChar("initial_T"));
  SET_STRING_ELT(nms, 331, mkChar("initial_U"));
  SET_STRING_ELT(nms, 332, mkChar("interpolate_beta"));
  SET_STRING_ELT(nms, 333, mkChar("interpolate_eta_h"));
  SET_STRING_ELT(nms, 334, mkChar("interpolate_eta_l"));
  SET_STRING_ELT(nms, 335, mkChar("interpolate_vax_switch_1"));
  SET_STRING_ELT(nms, 336, mkChar("kappa"));
  SET_STRING_ELT(nms, 337, mkChar("lambda"));
  SET_STRING_ELT(nms, 338, mkChar("mu"));
  SET_STRING_ELT(nms, 339, mkChar("N"));
  SET_STRING_ELT(nms, 340, mkChar("n_AT"));
  SET_STRING_ELT(nms, 341, mkChar("n_AU"));
  SET_STRING_ELT(nms, 342, mkChar("n_diag_rec"));
  SET_STRING_ELT(nms, 343, mkChar("n_doses"));
  SET_STRING_ELT(nms, 344, mkChar("n_group"));
  SET_STRING_ELT(nms, 345, mkChar("N_hesgroup"));
  SET_STRING_ELT(nms, 346, mkChar("n_obe"));
  SET_STRING_ELT(nms, 347, mkChar("n_ood"));
  SET_STRING_ELT(nms, 348, mkChar("n_oopn"));
  SET_STRING_ELT(nms, 349, mkChar("n_oos"));
  SET_STRING_ELT(nms, 350, mkChar("n_ST"));
  SET_STRING_ELT(nms, 351, mkChar("n_TU"));
  SET_STRING_ELT(nms, 352, mkChar("n_UI"));
  SET_STRING_ELT(nms, 353, mkChar("n_vax"));
  SET_STRING_ELT(nms, 354, mkChar("n_vbe"));
  SET_STRING_ELT(nms, 355, mkChar("n_vod"));
  SET_STRING_ELT(nms, 356, mkChar("n_vopn"));
  SET_STRING_ELT(nms, 357, mkChar("n_vos"));
  SET_STRING_ELT(nms, 358, mkChar("notifiedprev"));
  SET_STRING_ELT(nms, 359, mkChar("Np"));
  SET_STRING_ELT(nms, 360, mkChar("nu"));
  SET_STRING_ELT(nms, 361, mkChar("offset_variable_A"));
  SET_STRING_ELT(nms, 362, mkChar("offset_variable_cum_diag_a"));
  SET_STRING_ELT(nms, 363, mkChar("offset_variable_cum_diag_s"));
  SET_STRING_ELT(nms, 364, mkChar("offset_variable_cum_entrants"));
  SET_STRING_ELT(nms, 365, mkChar("offset_variable_cum_incid"));
  SET_STRING_ELT(nms, 366, mkChar("offset_variable_cum_lifeyears_U"));
  SET_STRING_ELT(nms, 367, mkChar("offset_variable_cum_offered"));
  SET_STRING_ELT(nms, 368, mkChar("offset_variable_cum_offered_pn"));
  SET_STRING_ELT(nms, 369, mkChar("offset_variable_cum_offered_vbe"));
  SET_STRING_ELT(nms, 370, mkChar("offset_variable_cum_screened"));
  SET_STRING_ELT(nms, 371, mkChar("offset_variable_cum_treated"));
  SET_STRING_ELT(nms, 372, mkChar("offset_variable_cum_vaccinated"));
  SET_STRING_ELT(nms, 373, mkChar("offset_variable_cum_vaccinated_pn"));
  SET_STRING_ELT(nms, 374, mkChar("offset_variable_cum_vaccinated_screen"));
  SET_STRING_ELT(nms, 375, mkChar("offset_variable_cum_vbe"));
  SET_STRING_ELT(nms, 376, mkChar("offset_variable_S"));
  SET_STRING_ELT(nms, 377, mkChar("offset_variable_T"));
  SET_STRING_ELT(nms, 378, mkChar("omega_U"));
  SET_STRING_ELT(nms, 379, mkChar("omega_U_withdiag"));
  SET_STRING_ELT(nms, 380, mkChar("omega_U_withdiag_rg"));
  SET_STRING_ELT(nms, 381, mkChar("p"));
  SET_STRING_ELT(nms, 382, mkChar("phi"));
  SET_STRING_ELT(nms, 383, mkChar("prop_C"));
  SET_STRING_ELT(nms, 384, mkChar("prop_C_hesgroup"));
  SET_STRING_ELT(nms, 385, mkChar("prop_C_hesriskgroup"));
  SET_STRING_ELT(nms, 386, mkChar("prop_UUsubgroup"));
  SET_STRING_ELT(nms, 387, mkChar("psi"));
  SET_STRING_ELT(nms, 388, mkChar("q"));
  SET_STRING_ELT(nms, 389, mkChar("rho"));
  SET_STRING_ELT(nms, 390, mkChar("S0"));
  SET_STRING_ELT(nms, 391, mkChar("screened"));
  SET_STRING_ELT(nms, 392, mkChar("sigma"));
  SET_STRING_ELT(nms, 393, mkChar("stratum_doses"));
  SET_STRING_ELT(nms, 394, mkChar("T0"));
  SET_STRING_ELT(nms, 395, mkChar("tt"));
  SET_STRING_ELT(nms, 396, mkChar("u_d"));
  SET_STRING_ELT(nms, 397, mkChar("u_pn"));
  SET_STRING_ELT(nms, 398, mkChar("u_s"));
  SET_STRING_ELT(nms, 399, mkChar("u_vbe"));
  SET_STRING_ELT(nms, 400, mkChar("U0"));
  SET_STRING_ELT(nms, 401, mkChar("Up"));
  SET_STRING_ELT(nms, 402, mkChar("vax_switch_2"));
  SET_STRING_ELT(nms, 403, mkChar("vax_switch_3"));
  SET_STRING_ELT(nms, 404, mkChar("vax_t"));
  SET_STRING_ELT(nms, 405, mkChar("vax_y"));
  SET_STRING_ELT(nms, 406, mkChar("vbe"));
  SET_STRING_ELT(nms, 407, mkChar("vea"));
  SET_STRING_ELT(nms, 408, mkChar("ved"));
  SET_STRING_ELT(nms, 409, mkChar("vei"));
  SET_STRING_ELT(nms, 410, mkChar("ves"));
  SET_STRING_ELT(nms, 411, mkChar("vod"));
  SET_STRING_ELT(nms, 412, mkChar("vopn"));
  SET_STRING_ELT(nms, 413, mkChar("vos"));
  SET_STRING_ELT(nms, 414, mkChar("w"));
  SET_STRING_ELT(nms, 415, mkChar("wA"));
  SET_STRING_ELT(nms, 416, mkChar("wd"));
  SET_STRING_ELT(nms, 417, mkChar("wdA"));
  SET_STRING_ELT(nms, 418, mkChar("wdI"));
  SET_STRING_ELT(nms, 419, mkChar("wdS"));
  SET_STRING_ELT(nms, 420, mkChar("wdT"));
  SET_STRING_ELT(nms, 421, mkChar("wdU"));
  SET_STRING_ELT(nms, 422, mkChar("wI"));
  SET_STRING_ELT(nms, 423, mkChar("willing"));
  SET_STRING_ELT(nms, 424, mkChar("wS"));
  SET_STRING_ELT(nms, 425, mkChar("wT"));
  SET_STRING_ELT(nms, 426, mkChar("wU"));
...
SEXP model_set_user(SEXP internal_p, SEXP user) {
  ...
  internal->dim_cum_lifeyears_U_1 = internal->n_group;
  internal->dim_cum_lifeyears_U_2 = internal->n_vax;
  ...
  internal->dim_n_doses_1 = internal->n_group;
  internal->dim_n_doses_2 = internal->n_vax;
  internal->dim_n_doses_3 = internal->n_vax;
  ...
  internal->dim_stratum_doses = internal->n_vax;
  ...
  interpolate_check_y(internal->dim_vax_t, internal->dim_vax_y, 0, "vax_y", "vax_switch_1");
  cinterpolate_free(internal->interpolate_vax_switch_1);
  internal->interpolate_vax_switch_1 = cinterpolate_alloc("constant", internal->dim_vax_t, 1, internal->vax_t, internal->vax_y, true, false);
  R_Free(internal->prop_C_hesgroup);
  ...
  internal->dim_cum_lifeyears_U = internal->dim_cum_lifeyears_U_1 * internal->dim_cum_lifeyears_U_2;
  ...
  internal->dim_n_doses = internal->dim_n_doses_1 * internal->dim_n_doses_2 * internal->dim_n_doses_3;
  internal->dim_n_doses_12 = internal->dim_n_doses_1 * internal->dim_n_doses_2;
  ...
  internal->stratum_doses = (double*) user_get_array(user, false, internal->stratum_doses, "stratum_doses", NA_REAL, NA_REAL, 1, internal->dim_stratum_doses);
  ...
  R_Free(internal->initial_cum_lifeyears_U);
  internal->initial_cum_lifeyears_U = (double*) R_Calloc(internal->dim_cum_lifeyears_U, double);
  R_Free(internal->initial_cum_offered);
  ...
  R_Free(internal->n_doses);
  internal->n_doses = (double*) R_Calloc(internal->dim_n_doses, double);
  R_Free(internal->N_hesgroup);
  ...
  for (int i = 1; i <= internal->dim_cum_lifeyears_U_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_lifeyears_U_2; ++j) {
      internal->initial_cum_lifeyears_U[i - 1 + internal->dim_cum_lifeyears_U_1 * (j - 1)] = 0;
    }
  }
  ...
  internal->offset_variable_cum_vbe = internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_incid + internal->dim_cum_lifeyears_U + internal->dim_cum_offered + internal->dim_cum_offered_pn + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_cum_vaccinated + internal->dim_cum_vaccinated_pn + internal->dim_cum_vaccinated_screen + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U;
...
SEXP model_metadata(SEXP internal_p) {
  ...
  int * dim_cum_lifeyears_U = INTEGER(VECTOR_ELT(variable_length, 15));
  dim_cum_lifeyears_U[0] = internal->dim_cum_lifeyears_U_1;
  dim_cum_lifeyears_U[1] = internal->dim_cum_lifeyears_U_2;
  SET_VECTOR_ELT(variable_length, 16, allocVector(INTSXP, 2));
  int * dim_cum_vbe = INTEGER(VECTOR_ELT(variable_length, 16));
  ...
  int * dim_cum_offered_vbe = INTEGER(VECTOR_ELT(variable_length, 17));
  ...
  int * dim_cum_entrants = INTEGER(VECTOR_ELT(variable_length, 18));
  ...
  SET_STRING_ELT(variable_names, 15, mkChar("cum_lifeyears_U"));
  SET_STRING_ELT(variable_names, 16, mkChar("cum_vbe"));
  SET_STRING_ELT(variable_names, 17, mkChar("cum_offered_vbe"));
  SET_STRING_ELT(variable_names, 18, mkChar("cum_entrants"));
  ...
  SET_STRING_ELT(output_names, 0, mkChar("case_rate"));
  SET_STRING_ELT(output_names, 1, mkChar("dose_rate"));
...
SEXP model_initial_conditions(SEXP internal_p, SEXP t_ptr) {
  model_internal *internal = model_get_internal(internal_p, 1);
  SEXP r_state = PROTECT(allocVector(REALSXP, internal->dim_A + internal->dim_cum_diag_a + internal->dim_cum_diag_s + internal->dim_cum_entrants + internal->dim_cum_incid + internal->dim_cum_lifeyears_U + internal->dim_cum_offered + internal->dim_cum_offered_pn + internal->dim_cum_offered_vbe + internal->dim_cum_screened + internal->dim_cum_treated + internal->dim_cum_vaccinated + internal->dim_cum_vaccinated_pn + internal->dim_cum_vaccinated_screen + internal->dim_cum_vbe + internal->dim_I + internal->dim_S + internal->dim_T + internal->dim_U));
  ...
  memcpy(state + internal->offset_variable_cum_lifeyears_U, internal->initial_cum_lifeyears_U, internal->dim_cum_lifeyears_U * sizeof(double));
...
void model_rhs(model_internal* internal, double t, double * state, double * dstatedt, double * output) {
  ...
  double vax_switch_1 = 0.0;
  cinterpolate_eval(t, internal->interpolate_vax_switch_1, &vax_switch_1);
  for (int i = 1; i <= internal->dim_cum_lifeyears_U_1; ++i) {
    for (int j = 1; j <= internal->dim_cum_lifeyears_U_2; ++j) {
      dstatedt[internal->offset_variable_cum_lifeyears_U + i - 1 + internal->dim_cum_lifeyears_U_1 * (j - 1)] = U[internal->dim_U_1 * (j - 1) + i - 1];
    }
  }
  ...
  for (int i = 1; i <= internal->dim_n_ood_1; ++i) {
    for (int j = 1; j <= internal->dim_n_ood_2; ++j) {
      for (int k = 1; k <= internal->dim_n_ood_3; ++k) {
        internal->n_ood[i - 1 + internal->dim_n_ood_1 * (j - 1) + internal->dim_n_ood_12 * (k - 1)] = internal->vod[internal->dim_vod_12 * (k - 1) + internal->dim_vod_1 * (j - 1) + i - 1] * internal->n_TU[internal->dim_n_TU_1 * (k - 1) + i - 1] * internal->vax_switch_2;
      }
    }
  }
  ...
  for (int i = 1; i <= internal->dim_n_oos_1; ++i) {
    for (int j = 1; j <= internal->dim_n_oos_2; ++j) {
      for (int k = 1; k <= internal->dim_n_oos_3; ++k) {
        internal->n_oos[i - 1 + internal->dim_n_oos_1 * (j - 1) + internal->dim_n_oos_12 * (k - 1)] = internal->vos[internal->dim_vos_12 * (k - 1) + internal->dim_vos_1 * (j - 1) + i - 1] * internal->screened[internal->dim_screened_1 * (k - 1) + i - 1] * vax_switch_1;
      }
    }
  }
  ...
  for (int i = 1; i <= internal->dim_n_oopn_1; ++i) {
    for (int j = 1; j <= internal->dim_n_oopn_2; ++j) {
      for (int k = 1; k <= internal->dim_n_oopn_3; ++k) {
        internal->n_oopn[i - 1 + internal->dim_n_oopn_1 * (j - 1) + internal->dim_n_oopn_12 * (k - 1)] = internal->vopn[internal->dim_vopn_12 * (k - 1) + internal->dim_vopn_1 * (j - 1) + i - 1] * internal->phi[internal->dim_phi_1 * (k - 1) + i - 1] * internal->vax_switch_3;
      }
    }
  }
  for (int i = 1; i <= internal->dim_cum_offered_1; ++i) {
  ...
  if (output) {
    ...
    output[0] = odin_sum2(internal->n_AT, 0, internal->dim_n_AT_1, 0, internal->dim_n_AT_2, internal->dim_n_AT_1) + odin_sum2(internal->n_ST, 0, internal->dim_n_ST_1, 0, internal->dim_n_ST_2, internal->dim_n_ST_1);
    for (int i = 1; i <= internal->dim_n_doses_1; ++i) {
      for (int j = 1; j <= internal->dim_n_doses_2; ++j) {
        for (int k = 1; k <= internal->dim_n_doses_3; ++k) {
          internal->n_doses[i - 1 + internal->dim_n_doses_1 * (j - 1) + internal->dim_n_doses_12 * (k - 1)] = (j == k ? 0 : -(1) * (internal->n_vos[internal->dim_n_vos_12 * (k - 1) + internal->dim_n_vos_1 * (j - 1) + i - 1] + internal->n_vod[internal->dim_n_vod_12 * (k - 1) + internal->dim_n_vod_1 * (j - 1) + i - 1] + internal->n_vbe[internal->dim_n_vbe_12 * (k - 1) + internal->dim_n_vbe_1 * (j - 1) + i - 1] + internal->n_vopn[internal->dim_n_vopn_12 * (k - 1) + internal->dim_n_vopn_1 * (j - 1) + i - 1]) * internal->stratum_doses[j - 1]);
        }
      }
    }
    output[1] = odin_sum3(internal->n_doses, 0, internal->dim_n_doses_1, 0, internal->dim_n_doses_2, 0, internal->dim_n_doses_3, internal->dim_n_doses_1, internal->dim_n_doses_12);
  }
}
void model_rhs_dde(size_t neq, double t, double * state, double * dstatedt, void * internal) {
